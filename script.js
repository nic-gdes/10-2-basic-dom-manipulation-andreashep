...
pageTitle.textContent = "My arms are too short!";
...
dinoImg.src = "./images/cute-dino.jpeg";
...
let dinoFacts = [
    "This t-rex has lot\'s of friends in the pteredactyles and a brontosaurus.",
    "This little guy\'s name is Harry",
...
let cuteGuy = document.querySelector('#dinoFacts');
...
for (let i = 0; i < dinoFacts.length; i++) {
    ...
    newList.textContent = currentFact;
    cuteGuy.appendChild(newList);
}
